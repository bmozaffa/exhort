...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-5">
                <p>Below is a list of dependencies affected with CVE, as well as vulnerability only found using Snyk's
        ...
        <#list body.directs as dependency>
            <tr data-toggle="collapse" data-target="#${dependency.getHtmlName()}" class="accordion-toggle">
                ...
                <#if (dependency.countDirectVulnerabilities() != 0) >
                    ...
                    <td>
                        ...
                        <div class="pf-c-progress pf-m-danger" id="progress-simple-example">
                            ...
                            <div class="pf-c-progress pf-m-warning" id="progress-simple-example">
                                ...
                                >${dependency.getHighestVulnerability().rawData().get("cvssScore")}/10
                                </div>
                                <div
                    ...
                    <td>
                        <#if dependency.isRHRemediationAvail()>
                            <#if dependency.remediations()?size != 0>
                                <div style="margin-bottom: 10px;">
                                    <svg style="width: 10.9793322px; height: 13px" version="1.1"
            ...
            <tr class="pf-c-table__expandable-row pf-m-expanded">
                <td colspan="8" class="hiddenRow">
                    <div class="accordion-body collapse p-4 bg-light" id="${dependency.getHtmlName()}">
                                        ...
                                        <#list dependency.dependencyReport.issues() as vulnerability>
                                            <tr>
                                                ...
                                                <#if body.issueVisibilityHelper.showIssue(vulnerability)>
                                                    ...
                                                    <#else>
                                                        <td><a href="${body.snykSignup}"
                                                            ...
                                                            </a>to find out which vulnerabilities have a publicly known
                                                            exploits
                                                        </td>
                                                    </#if>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="pf-c-progress pf-m-danger" id="progress-simple-example">
                                                        <#else>
                                                        <div class="pf-c-progress pf-m-warning"
                                                            ...
                                                            <div
                                                                    ...
                                                                    aria-labelledby="progress-simple-example-description"
                                                            >
                                                                <div class="pf-c-progress__indicator"
                                                                     style="width:${barNum}%;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <#if remediation?has_content>
                                                        ...
                                                        <button type="button" class="btn btn-link" data-toggle="modal"
                                                                data-target="#modal"
                                                                data-vex="${vexLink(vulnerability.cves()[0])}"
                                                                data-sbom="${body.sbomPath}"
                                                                data-link="${repoLink(remediation)}"
                                                                data-rhpkg="${remediation.version()}">
                                                            ${remediation.version()}
                                                        </button>
                                                        <#assign remediation = dependency.findRemediationByIssue(vulnerability)!>
                                                    <#else>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Click either VEX or SBOM to download the corresponding file type. You can also click the package name to
                view more information in Red Hat's Maven repository.
            </div>
